    ...
    <div id="app-menu-scrollbar" data-scrollbar
        ...
        <div class="group-data-[sidebar-size=lg]:max-h-full">
            <ul id="navbar-nav"
                ...
                <li
                    class="hidden relative group/sm w-full group-data-[sidebar-size=sm]:hover:w-[calc(theme('spacing.app-menu-sm')_*_3.4)] group-data-[sidebar-size=sm]:flex-center">
