<div class="col-span-full 2xl:col-span-full card">
    <div class="grid grid-cols-12 gap-4 h-full">
        <!-- Total Sale Card -->
        <div class="col-span-full md:col-span-6 lg:col-span-4 p-4 dk-border-one rounded-xl h-full dk-theme-card-square">
        ...
        <div class="hidden col-span-full md:col-span-6 lg:col-span-4 p-4 dk-border-one rounded-xl h-full dk-theme-card-square">
            <div class="flex-center-between">
                <h6 class="leading-none text-gray-500 dark:text-dark-text font-semibold">
