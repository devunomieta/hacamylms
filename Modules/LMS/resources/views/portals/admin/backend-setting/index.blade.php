                    ...
                    <div class="mt-7">
                        <div class="leading-none">
                            ...
                            <input type="number" name="platform_fee"
                                placeholder="{{ translate('Enter Platform Fee') }}" class="form-input" step="0.01"
                            ...
                            <select class="singleSelect form-input" id="time_zone" name="time_zone">
                                ...
                                @foreach (getTimezone() as $key => $getTimezone)
                                    <option value="{{ $getTimezone['value'] }}"
                                        {{ isset($backendSetting) && $backendSetting['time_zone'] == $getTimezone['value'] ? 'selected' : '' }}>
                                        {{ $getTimezone['label'] }}
                                    </option>
                                @endforeach
