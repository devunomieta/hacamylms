<x-dashboard-layout>
    ...
    <div class="card flex justify-end">
        <button type="button" data-modal-id="payout-modal" class="btn b-solid btn-primary-solid dk-theme-card-square">
    ...
    <div id="payout-modal" class="fixed inset-0 z-modal flex-center !hidden bg-black/50 modal">
        <div
