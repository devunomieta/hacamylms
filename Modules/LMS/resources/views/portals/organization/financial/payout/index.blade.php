            ...
            <table
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                    @foreach ($payoutHistories as $payoutHistory)
                        <tr>
                            <td class="px-3.5 py-4"> <h6 class="text-md leading-none"> <a href="#">{{ $payoutHistory->payout_number }}</a> </h6></td>
                            <td class="px-3.5 py-4">${{ $payoutHistory->amount }}</td>
                            <td class="px-3.5 py-4">{{ customDateFormate($payoutHistory->created_at, $format = 'd M y h:i A') }}</td>
