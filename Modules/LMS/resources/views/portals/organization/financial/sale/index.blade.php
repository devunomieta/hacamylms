...
<x-dashboard-layout>
    <x-slot:title>{{ translate('Sales Manager') }}</x-slot:title>
    <!-- BREADCRUMB -->
    ...
    <div class="card">
        <div class="grid grid-cols-6 gap-4">
            <x-portal::admin.course-overview-card color-type="success"  title="Total Course Sales"
                value="${{ $reports['total_course_sale'] ?? 0 }}" />
            <x-portal::admin.course-overview-card color-type="danger" title="Total Bundled Sales"
