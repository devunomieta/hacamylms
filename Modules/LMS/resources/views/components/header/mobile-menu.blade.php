    ...
    <div class="offcanvas-menu-inner absolute top-0 bottom-0 right-0 rtl:right-auto rtl:left-0 flex flex-col py-4 bg-white w-64 sm:w-72 translate-x-full rtl:-translate-x-full duration-300 z-[103]">
        ...
        <div class="my-5 px-4 overflow-x-hidden grow">
            <ul class="leading-none text-heading dark:text-white font-medium">
                ...
                <li>
                    <a href="{{ route('category.list') }}" aria-label="Menu link" class="inline-block w-full py-3 hover:text-primary [&.active]:text-primary custom-transition">
                        {{ translate('Categories') }}
                    </a>
                </li>
                <li>
                    <a href="{{ route('organization.list') }}" aria-label="Menu link" class="inline-block w-full py-3 hover:text-primary [&.active]:text-primary custom-transition">
                ...
                <li>
                    ...
                    <ul class="flex flex-col">
                        <li>
                            <a href="{{ route('about.us') }}" aria-label="Menu link" class="sub-menu-link">
                                {{ translate('About Us') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('contact.page') }}" aria-label="Menu link" class="sub-menu-link">
                                {{ translate('Contact Us') }} 
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('blog.list') }}" aria-label="Menu link" class="sub-menu-link">
                                {{ translate('Blogs') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('privacy.policy') }}" aria-label="Menu link" class="sub-menu-link">
                                {{ translate('Privacy Policy') }}
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('terms.condition') }}" aria-label="Menu link" class="sub-menu-link">
