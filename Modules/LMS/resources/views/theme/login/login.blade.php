...
<x-auth-layout class="home-online-education" :data="$settings">
    <div class="min-w-full min-h-screen flex items-center">
        <div class="grow min-h-screen h-full w-full pt-40 pb-12 px-3 lg:p-3 flex-center flex-col">
            ...
            <div class="dashkit-tab flex-center gap-2 flex-wrap mt-10" id="userRegisterTab">
                ...
                <button type="button" aria-label="Login tab for Admin"
                    class="d-none dashkit-tab-btn btn b-light btn-primary-light btn-lg h-11 !rounded-full text-[14px] sm:text-[16px] md:text-[18px] [&.active]:bg-primary [&.active]:text-white"
                    id="admin">
                    {{ translate('') }}
                </button>
            </div>
