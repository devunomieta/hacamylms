<x-auth-layout>
    <div class="min-w-full min-h-screen flex items-center">
        <div class="grow min-h-screen h-full w-full pt-40 pb-12 px-3 lg:p-3 flex-center flex-col" style="margin-top: 50px;">
            <h2 class="area-title">{{ translate('Create Account') }}!</h2>
            <div class="dashkit-tab flex-center gap-2 flex-wrap mt-10" id="userRegisterTab">
                ...
                <button type="button" aria-label="User registration tab for Tutor"
                    ...
                    id="asInstructor">{{ translate('Tutor') }}</button>
                            ...
                            <div class="col-span-full">
                                <div class="relative">
                                    <input type="text" id="ins_designation" name="designation"
                                        class="form-input rounded-full peer" placeholder="" />
                                    <label for="ins_designation" class="form-label floating-form-label">{{ translate('Occupation') }}
                ...
                <div class="dashkit-tab-pane" data-tab="asOrganization">
                    <form action="{{ route('auth.register') }}" method="POST" class="form">
                        ...
                        <div class="grid grid-cols-2 gap-x-3 gap-y-5">
                            <div class="col-span-full">
                                <div class="relative">
                                    <input type="text" id="org_name" name="name"
                                        class="form-input rounded-full peer" placeholder="" />
                                    <label for="org_name" class="form-label floating-form-label">{{ translate('Name of Organization') }} <span
                                            class="text-danger">*</span></label>
                                </div>
                            ...
                            <div class="col-span-full lg:col-auto">
                                <div class="relative">
                                    <input type="email" id="org_email" name="email"
                                        class="form-input rounded-full peer" placeholder="" />
                                    <label for="org_email" class="form-label floating-form-label">{{ translate('Org Email') }} <span
                                            class="text-danger">*</span></label>
                                </div>
                                <span class="error-text email_err"></span>
                            </div>
                            <div class="col-span-full lg:col-auto">
                                <div class="relative">
                                    <input type="text" id="org_phone" name="phone"
                                        class="form-input rounded-full peer" placeholder="" />
                                    <label for="org_phone" class="form-label floating-form-label">{{ translate('Org Phone') }} <span
                                            class="text-danger">*</span></label>
                                </div>
                                <span class="error-text phone_err"></span>
                            </div>
                            ...
                            <div class="col-span-full">
                                <div class="relative">
                                    <textarea id="org_address" name="address" rows="10" class="form-input rounded-2xl  peer" placeholder=""></textarea>
